...
client.on('ready', () =>{ // ивент, когда бот запускается https://discord.js.org/#/docs/main/stable/class/Client?scrollTo=e-ready
    client.generateInvite("ADMINISTRATOR").then(invite => console.log(`https://discord.gg/hQCCmZq5aZ ${invite}`))
...
client.login('OTI4NzQ0NjMyMTI3NDgzOTc0.YddO1w.QbMeEqgWOXLZ4AAquT_szWS6rRo') // токен вашего бота
